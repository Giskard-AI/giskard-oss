...
class ExtractionCheck[InputType, OutputType, TraceType: Trace](  # pyright: ignore[reportMissingTypeArgument]
    ...
    extractor: Extractor[InputType, OutputType] | None = Field(
    ...
    def _extract_values(self, trace: TraceType) -> list[Any]:
