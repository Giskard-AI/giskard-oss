...
scenario1 = Scenario("s1").interact("hello").check(Equals(expected_value="Echo: hello"))
scenario2 = Scenario("s2").interact("world").check(Equals(expected_value="Echo: world"))
